      ...
      ? html`
          <div class="container">
            <div class="filas">
              ...
              <div class="fllw">
                <span @mouseover="${this.handleHoverFllw}" @mouseout="${this.handleOutFllw}" class="hoverFollowers"
                  >${people}</span
                >
                <b>${this.data.followers ?? '-'}</b>
                <span @mouseover="${this.handleHoverFllw}" @mouseout="${this.handleOutFllw}" class="hoverFollowers"
                  >followers</span
                >
                &middot; <b>${this.data.following ?? '-'}</b>
                <span @mouseover="${this.handleHover}" @mouseout="${this.handleOut}" class="hoverFollowing"
                  >following</span
                >
              </div>
              ...
              <div class="blog">
                ...
                <a
                  ...
                  >${(this.data.blog ?? '-') === '' ? '-' : this.data.blog}</a
                >
              </div>
            </div>
          </div>
